...
public class FriendFragment extends BaseFragment implements FriendAdapter.IOnClickFriend {
    ...
    public void onClickFiend(int pos, Friend friend) {
        if (friend.isChecked()) {
            ...
            Iterator itr = friendSelectedArr.iterator();
            itr.remove();
        }
    }
